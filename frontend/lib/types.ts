...
/** Un material elegido para una tarea: la cantidad que se va a usar, más un
 * número por cada valor que pide su métrica (p. ej. para "Peso (kg) /
 * Longitud (m)": { "Peso (kg)": 120, "Longitud (m)": 5 }). Cada fila es
